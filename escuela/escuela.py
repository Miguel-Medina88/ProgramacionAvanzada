...
class Escuela:
    ...
    def registrar_alumno_en_grupo(self, numero_control_estudiante: str, id_grupo: str):
        estudiante = self.buscar_estudiante_por_id(
        ...
        if grupo == None:
            print("NO se encontro el grupo con ese id ")
            return
    ...
    def ver_grupos_asignados_a_estudiante(self, numero_control_estudiante: str):
        ...
        if estudiante == None:
            print("NO se econtro al alumno con ese numero de control ")
            return
